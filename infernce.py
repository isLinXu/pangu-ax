...
def alpha_inference(input, input_file=None, model='2B6', load='ckpts/onnx_int8_pangu_alpha_2b6/',
...
def alpha_evolution_inference(input,  input_file=None, model='2B6', load='ckpts/onnx_int8_pangu_evolution_2b6/',
